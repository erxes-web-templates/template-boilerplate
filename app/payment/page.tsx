      ...
      <Dialog open={modalOpen} onOpenChange={handleCloseModal}>
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              {modalStatus === "paid" &&
                "Таны захиалга баталгаажлаа. Удахгүй нүүр хуудас руу шилжинэ."}
              {modalStatus === "expired" &&
                "Төлбөрийн хугацаа (5 мин) дууссан. Дахин оролдоно уу."}
              {modalStatus === "cancelled" &&
                "Захиалга цуцлагдлаа. Дэлгүүр рүү буцаж байна..."}
              {modalStatus === "pending" &&
